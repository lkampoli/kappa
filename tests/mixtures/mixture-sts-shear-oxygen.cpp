...
//    // attempt to make composition vector automatic
//    std::vector<std::pair<std::string,double>> composition;
//    composition.push_back(std::make_pair("N2", 1.0));
//    //composition.push_back(std::make_pair("O2", 0.2));
//    //composition.push_back(std::make_pair("NO", 0.2));
//    composition.push_back(std::make_pair("N", 0.0));
//    //composition.push_back(std::make_pair("O", 0.2));
//    std::cout << "composition's size: " << composition.size() << std::endl;
//    std::cout << std::setw(15) << "species";
//    std::cout << std::setw(15) << "mass fraction" << std::endl;
//    
//    for ( int i = 0; i < composition.size(); ++i ) {
//     std::cout << std::setw(15) << composition[i].first << std::setw(15) << composition[i].second << std::endl;
//    }
