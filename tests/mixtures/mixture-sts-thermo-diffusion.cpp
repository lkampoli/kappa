 ...
 * Test for thermal-diffusion coefficients' computation in the StS approach.
 */
...
int main(int argc, char** argv) {
   ...
   // spectroscopic constant for diatomic molecules in ground electronic state TODO check SI unit with oLgA
   ...
   // assume an initial boltzmann ditribution at the lowest temperature (2500)
   ...
   for (auto T : T_vals) {
      ...
      // real computation of transport coefficients
