...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  double kappa::Approximation::p_rot_collision_number_parker(double T, double xi_inf, double epsilon) {
    ...
    return xi_inf /  ( 1 + pow(K_CONST_PI, 1.5) * pow(kTe, -0.5) / 2 + (K_CONST_PI * K_CONST_PI / 4 + 2) 
            / kTe + pow(K_CONST_PI, 1.5) * pow(kTe, -1.5));
  }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  double kappa::Approximation::omega_integral_ESA_ne(double T, double g1, double g2, double g3, double g4, double g5, double g6, 
          double g7, double g8, double g9, double g10, double diameter) {

    double x = log(T);
    double exp_1 = exp(x - g1 / g2);

    return (g3 * pow(x, g6) * exp_1 / (exp_1 + 1. / exp_1) + g7 * exp(-(x - g8) * (x - g8) / (g9 * g9)) + g4 + g10 * pow(x, g5)) 
        / (diameter * diameter);
  }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  double kappa::Approximation::omega_integral(double T, kappa::Interaction const &interaction, int l, int r, 
