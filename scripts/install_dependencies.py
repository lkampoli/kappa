...
LAPACK_DIR = os.path.join(os.environ["MPP_DIRECTORY"], "thirdparty/lapack-3.8.0/build/lib")
            ...
            "OpenBLAS": Dependency(
                ...
                build_cmd_seq=[[cmd_dict["cmake"],
                               ...
                               [cmd_dict["make"],
                                "-j", str(args.jobs),
                                "install"]]),
            "armadillo-8.600.0": Dependency(
                name="armadillo-8.600.0",
                build_cmd_seq=[[cmd_dict["cmake"],
                                "-DCMAKE_INSTALL_PREFIX={}".format(MPP_INSTALL_DIRECTORY),
                                "-DLAPACK_LIBRARY:FILEPATH={}".format(LAPACK_DIR),
                                "-DBUILD_SHARED_LIBS:BOOL=ON",
                                ".."],
                               [cmd_dict["make"],
                                "-j", str(args.jobs),
